...
class ReconnaissanceAnalyzer:
    ...
    def compute_sets(self, traces: Dict[str, Set[str]], feature_mapping: Dict[str, List[str]]) -> Dict[str, FeatureSets]:
        """
        Computes the software reconnaissance sets.
        traces: mapping of test_case -> set of executed components (e.g., functions)
        feature_mapping: mapping of feature -> list of test_cases
